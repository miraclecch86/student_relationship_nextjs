      ...
      <div className="p-3 border-b">
        <div className="flex gap-2 items-center">
          <input
            ...
            className="flex-grow min-w-0 px-3 py-1.5 border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-indigo-500 focus:border-indigo-500 text-sm shadow-sm"
          />
          <button
