...
**🔍 최신 설문 데이터 심층 분석**: 
• **개별 학생 관계 변화 추적**: 최신 설문에서 이전 대비 **관계가 변화한 모든 학생**을 빠짐없이 식별하고 분석하세요. 새롭게 **'친해' 관계를 맺은 학생 조합**, **'불편해'로 변화한 관계**, **'친해질래'에서 '친해'로 발전한 케이스**, **관계가 소원해진 학생들**을 구체적 학생명과 함께 상세 분석하세요.
...
- 관계 변화 추이: 시간에 따른 관계 발전 및 변화 패턴을 깊이 있게 분석하세요. 어떤 관계가 강해지거나 약해졌는지, 그 원인과 과정, 앞으로 예상되는 **관계 변화 방향**을 구체적으로 예측하세요.
...
- 정서 특성: 감정 조절 능력의 현재 상태를 상세히 평가하세요. 감정 표현의 방식과 빈도, 스트레스 상황에서의 반응, **감정 조절 능력**의 수준과 특징, 정서적 성숙도를 구체적으로 분석하세요.
- 인지적 특성: 사고 방식, 문제 해결 접근법, 학습 성향을 종합적으로 분석하세요. 논리적/직관적 사고 선호도, 창의성과 분석력, **학습 스타일**과 정보 처리 방식, 호기심과 탐구 욕구의 정도를 상세히 서술하세요.
- 자아 개념: 자기 인식과 자존감, 자기 효능감의 현재 상태를 깊이 있게 분석하세요. 자신에 대한 인식의 정확성, **자존감 수준**, 도전에 대한 자신감, 실패와 성공에 대한 반응 패턴을 구체적으로 설명하세요.
...
- 숨겨진 잠재력: 향후 발현 가능한 재능과 성장 가능성을 깊이 있게 탐색하세요. 아직 충분히 발휘되지 않은 숨겨진 능력, 적절한 기회가 주어졌을 때 나타날 수 있는 **잠재력**을 구체적으로 예측하세요.
...
🚨 **REMINDER**: 정말 핵심적인 키워드만 선별하여 볼드 처리하세요! (기존 1/3 수준으로 줄여서)
- 핵심 관찰 포인트: 교실에서 지속 관찰할 구체적 행동과 변화 신호를 상세히 제시하세요. 주의 깊게 봐야 할 언어적/비언어적 신호, 행동 변화의 조기 징후, 정서 상태 파악을 위한 **관찰 포인트**, 성장과 퇴행의 지표를 구체적으로 설명하세요.
